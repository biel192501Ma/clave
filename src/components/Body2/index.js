...
const Body2 = () =>{
  ...
  return(
      <Bgimg3 id="certificado" width={654} height={320} className="bgimgbody2"  >
        ...
        <Container id="certificado" row width={154}  >
          {/*imgs*/}
          <Box>
           ...
           <div className="fundo2" > </div>
             ...
             <Box paddingLeft={250}  paddingRight={10} paddingTop={30} data-aos="fade-down" className="boxsubtitlebody2" >
                ...
                <Box color="white" height={140} width={5} className="linebody2" ></Box>
                </Container>
        </Container>
      </Bgimg3>
  )
